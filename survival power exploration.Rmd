...
```{r exp, results='hide',eval=TRUE , echo=TRUE}
  ...
  curve(zp(x, shape=1, scale=1/lambda), from=0, to=end, 
         main=paste0("A change in survival probability at fixed time:\n S(t) for exponential rates ",
                     formatz2(lambda)," (red) and ",formatz2(lambda2), " (blue). HR= ",
                     formatz2(lambda/lambda2),".\nMortalities at time ",
                     formatz4(ms),": ",formatz2(p*100),"% and ", 
                     formatz2((1-mort1)*100 ), "% respectively" ), cex.main = .8,
...
```{r exp2, results='hide',eval=TRUE , echo=TRUE}
 ...
 curve(zp(x, shape=1, scale=1/lambda), from=0, to=end, 
       main=paste0("A change in survival time fixed survival probability:\n S(t) for exponential rates ",formatz2(lambda)," (blue) and ",formatz2(lambda2), " (red). HR= ",formatz2(hr),".\n A survival probability of ",formatz4(p)," for the reference has survival time ",
                   formatz2( ref.time),". \nA ",formatz2(fact.*100) ,"% increase in the survival time results in a survival time of ",formatz2(trt.time)," (red)"),  cex.main = .8,
