...
# Two self written functions just plots to gain understanding, they do not use follow up nor accrual time.
...
```{r knitr purl code, results='hide'}
    ...
    # saving the html  m/questions/28894515/rmarkdown-directing-output-file-into-a-directory
