dashboardSidebar(
  ...
  sidebarMenu(
    ...
    menuItem("Code",   icon = icon("users" ),  
             ...
             menuSubItem(h5(HTML( "Here's some Rmarkdown code, produce similar analyses")),
                         icon = icon("send",lib='glyphicon'), 
                         href = "https://raw.githubusercontent.com/eamonn2014/Survival-power/master/survival%20power%20exploration.Rmd"),
